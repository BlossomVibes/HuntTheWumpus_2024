...
var curMap = [[37, 37, 38,37, 37, 38,37, 37, 38,37, 37, 38,37, 37, 38,37, 37, 38], [20, 51, 94], [146, 143, 282]];
...
function BeginWumpusFight () {

}
function MovePlayer (direction) {
// moves the player to the adjacent room that they picked.
// calls move wumpus at the same time.
}
...
function GenerateChests () {
    // all this function needs to do is create a trapped chest.
    // to generate the random chest loot, we summon a custom mob with a custom loot table with the items.
    //
}
