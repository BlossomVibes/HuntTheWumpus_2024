...
function mainTick() {
    ...
    if (system.currentTick % 5 === 0) {
        ...
        if (playerX >= 7 && playerX <= 9 && playerY <= 4 && playerY >= 0 && playerZ >= -2 && playerZ <= 1) {
            world.sendMessage("northeast");

           player.teleport({x: 19, y: 1, z: 19});
        ...
        if (playerX >= 1 && playerX <= 3 && playerY <= 4 && playerY >= 0 && playerZ >= 10 && playerZ <= 12) {
        ...
        if (playerX >= 5 && playerX <= 7 && playerY <= 4 && playerY >= 0 && playerZ >= 18 && playerZ <= 20) {
        ...
        if (playerX >= 18 && playerX <= 20 && playerY <= 4 && playerY >= 0 && playerZ >= 11 && playerZ <= 13) {
        ...
        if (playerX >= 15 && playerX <= 17 && playerY <= 4 && playerY >= 0 && playerZ >= 18 && playerZ <= 20) {
        ...
        if (playerX >= 15 && playerX <= 17 && playerY <= 4 && playerY >= 0 && playerZ >= 1 && playerZ <= 3) {
